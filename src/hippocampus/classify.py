...
def classify(description: str) -> ClassificationResult:
    ...
    is_heavy = (
        category in HEAVY_CATEGORIES
        or bool(re.search(r'\b(multiple services|significant rework|irreversible|compliance|legal|cost commitment|serious mistake)\b', lower))
    )
